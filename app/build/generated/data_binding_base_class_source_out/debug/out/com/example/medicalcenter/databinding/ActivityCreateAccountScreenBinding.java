...
public final class ActivityCreateAccountScreenBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCreateAccountScreenBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextInputLayout emailInput, @NonNull Button forgotPassword,
      @NonNull ImageView loginAvatar, @NonNull ConstraintLayout main, @NonNull LinearLayout or,
      @NonNull Button orSignUpButton, @NonNull TextInputLayout passwordInput,
      @NonNull LinearLayout remember, @NonNull Button signUpButton,
      @NonNull LinearLayout socialButtons) {
  ...
  @NonNull
  public static ActivityCreateAccountScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCreateAccountScreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_create_account_screen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCreateAccountScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCreateAccountScreenBinding((ConstraintLayout) rootView, arrowImageButton,
          checkButton, createNewAccountText, dontHaveAccountText, emailInput, forgotPassword,
          loginAvatar, main, or, orSignUpButton, passwordInput, remember, signUpButton,
          socialButtons);
    }
