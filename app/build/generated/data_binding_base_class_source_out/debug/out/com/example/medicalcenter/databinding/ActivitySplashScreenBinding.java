...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView cpbar,
      @NonNull LinearLayout linear, @NonNull ConstraintLayout main) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cpbar;
      ImageView cpbar = ViewBindings.findChildViewById(rootView, id);
      if (cpbar == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, cpbar, linear, main);
    }
